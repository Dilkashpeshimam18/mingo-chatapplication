...
const AllMembers = () => {
    ...
    const getMemberOfRoom = async () => {
        try {
            ...
            const res = await reqInstance.get(`http://13.53.118.65:4000/member/get-member/${roomId}`)
    ...
    const removeMember = async (memberId: string | any) => {
        try {
            ...
            const res = await reqInstance.delete(`http://13.53.118.65:4000/member/remove-member/${roomId}/${memberId}`)
    ...
    const changeAdmin = async (userid: string) => {
        try {
            ...
            const res = await reqInstance.put(`http://13.53.118.65:4000/room/change-room-admin/${roomId}/${userid}`)
